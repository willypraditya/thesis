                                ...
                                legend: {
                                    ...
                                    labels: {
                                        ...
                                        generateLabels: (chart) => {
                                            ...
                                            const totalAmount = data.datasets[0].data.reduce((a, b) => a + b);
                                            ...
                                            data.labels.forEach((item, index) => {
                                                transformedData.push(
                                                    {
                                                        text: `${item} (${((data.datasets[0].data[index] / totalAmount) * 100).toFixed(1)}%) `,
                                ...
                                return(
                                    <ListItem style={{padding: 0, margin: 0}}>
                                        <ListItemText
                                            ...
                                            primary={`- ${formatCurrency(data.datasets[0].data[index])}`}
                                        />
                                    </ListItem>
                                );
                            })}
