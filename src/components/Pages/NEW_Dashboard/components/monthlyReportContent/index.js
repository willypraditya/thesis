            ...
            >
                ...
                <Grid item>
                    <Grid container spacing={1}>
                        ...
                        <Grid item>
                            <ButtonGroup classes={{groupedOutlined: classes.transactionTypeButtonGroup}} variant='outlined' aria-label="outlined primary button group">
                                <Button className={classes.transactionTypeButton} onClick={showAllTransactions}>All</Button>
                                <Button className={classes.transactionTypeButton} onClick={showIncomingTransactions}>
                                    <FiberManualRecord className={classes.incomingIcon}/> 
                                    Incoming
                                </Button>
                                <Button className={classes.transactionTypeButton} onClick={showOutgoingTransactions}>
