    ...
    return(
        <div>
            <Paper elevation={0} className={classes.homeHeader}>
                ...
                >
                    <Grid item>
                        <Typography className={classes.balance}>Rp 20.000.000,00</Typography>
                    </Grid>
                    <Grid item>
                        <div style={{marginTop: 20}}>
                            <Button variant='contained' className={classes.sendButton} onClick={() => handling.redirectUrl('/dashboard/send')}>
                                <CallMade className={classes.buttonIcon}/>
                                Send
                            </Button>
                            <Button variant='contained' className={classes.topUpButton} onClick={() => handling.redirectUrl('/dashboard/top-up')}>
            ...
            <div className={classes.homeContent}>
                            ...
                            <List className={classes.recentActivityList} >
                                {recentTransaction.map(item => 
                                    <ListItem className={classes.recentActivityListItem} button>
                                        <ListItemAvatar>
                                            {item.type === 'incoming' ? 
                                                <Avatar className={classes.recentActivityIncomingAvatar}>
                                                    <CallReceived className={classes.recentActivityIncomingIcon}/>
                                                </Avatar> :
                                                <Avatar className={classes.recentActivityOutgoingAvatar}>
                                                    <CallMade className={classes.recentActivityOutgoingIcon}/>
                                                </Avatar>}
                                        </ListItemAvatar>
                                        <Grid container 
                                            direction='row'
                                            ...
                                            <Grid item>
                                                {item.type === 'incoming' ? 
                                                    <ListItemText 
                                                        classes={{primary: classes.recentActivityIncomingAmount}} 
                                                        primary={`+ ${item.amount}`} 
                                                        secondary="Received"
                                                    ...
                                                    : 
                                                    <ListItemText 
                                                        classes={{primary: classes.recentActivityOutgoingAmount}} 
                                                        primary={`- ${item.amount}`} 
                                                        secondary="Sent"
                                                        secondaryTypographyProps={{align: 'right'}}
                                                    /> 
                ...
                <Paper elevation={0} style={{margin: '16px 0 0 0', minHeight: 450}}  className={classes.contentPaper}>
