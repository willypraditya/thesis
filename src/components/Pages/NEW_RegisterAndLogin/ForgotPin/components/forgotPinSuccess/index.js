    ...
    return(
        <React.Fragment>
            <div className={classes.content}>
                ...
                <Typography className={classes.description}>An email with reset PIN link has been sent to example@example.com with further instructions.</Typography>
            </div>
            ...
            <Grid container justify='flex-end'>
                <Grid item>
                    <Button variant='contained' className={classes.sendButton}>Back to Login</Button>
                </Grid>
            </Grid>
        </React.Fragment>
    );
