    ...
    return(
        <React.Fragment>
            <Grid container direction='column' spacing={2}>
                ...
                <Grid item>
                    <FormControlLabel
                        control={<Checkbox className={classes.checkbox} name="agreement" color="primary" />}
            ...
            <Grid container justify='flex-end'>
                <Grid item>
                    <Button variant='contained' className={classes.signUpButton} onClick={onClickSignUp}>Sign Up</Button>
                </Grid>
            </Grid>
        </React.Fragment>
    );
