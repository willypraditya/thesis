    ...
    return(
        <React.Fragment>
            ...
            <Container className={classes.timerContainer}>
                <Typography>
                    OTP will expire in <Typography display='inline' className={classes.timerText}>{moment.utc(timer).format('mm:ss')}</Typography>
                </Typography>
            </Container>
            ...
            />
            <Typography className={classes.noReceiveText}>Didn't receive SMS?</Typography>
            <Link href="#" className={classes.sendAgainText}>Send again.</Link>
            <div className={classes.footerDivider}>
                <Divider/>
            </div>
            <Grid container justify='flex-end'>
                <Grid item>
                    <Button variant='contained' className={classes.verifyButton}>Verify Now</Button>
                </Grid>
            </Grid>
        </React.Fragment>
    );
