            ...
            <Paper elevation={0} className={classes.paper}>
                ...
                <div>
                    <Grid container spacing={1}>
                        ...
                        <Grid item>
                            <Typography className={classes.awaitingTitle}>Awaiting Payment</Typography>
                        </Grid>
                    </Grid>
                    <Typography>
                        We have received your transfer request, please wait while we verify your payment. 
                        Once your payment is verified, we will process your request. 
