    ...
    <div>
      <Paper elevation={0} className={classes.paper}>
        ...
        <div>
          ...
          <Typography>
            We have received your transfer request. Your payment has been
            verified and we will process your request. You can refer to the
            transaction history page to check your transfer status.
          </Typography>
        </div>
      </Paper>
