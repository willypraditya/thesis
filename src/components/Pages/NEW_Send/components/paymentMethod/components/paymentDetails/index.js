          ...
          <FormControlLabel
            ...
            label={
              <Typography>
                ...
                <Typography display="inline" style={{ fontWeight: 600 }}>
                  {" "}
                  my {paymentMethod === "deposit" ? "deposits" : "wallet"}.{" "}
                </Typography>
              </Typography>
            }
          />
        ...
        <div>
          <Grid container justify="center" spacing={6}>
            <Grid item>
              <img
                alt="deposit-icon"
                src={`${constant.PREFIX_IMAGE}/icon/deposit.svg`}
              />
            ...
            <Grid item>
              <img
                alt="arrow-icon"
                src={`${constant.PREFIX_IMAGE}/icon/arrows.svg`}
                style={{ marginTop: 45 }}
              />
            </Grid>
            <Grid item>
              <img
                alt="recipient-icon"
                src={`${constant.PREFIX_IMAGE}/icon/recipient.svg`}
              />
              <Typography align="center">50 recipients</Typography>
            </Grid>
          </Grid>
          <Typography className={classes.noteText}>
            Note: An admin fee of 1% will be charged on your total amount
            transferred should you fail to comply with our
