...
const PaymentMethod = ({nextStep, paymentMethod, setPaymentMethodFunction}) => {
    ...
    return (
        <div>
            <Paper elevation={0} className={classes.paper}>
                <Typography className={classes.paymentMethodTitle}>Payment Method</Typography>
                ...
                <div>
                    <Grid container spacing={2}>
                        <Grid item xs={6}>
                            <Typography className={classes.contentTitle}>Reference Code</Typography>
                            <TextField 
                                variant='outlined'
                        ...
                        <Grid item xs={6}>
                            ...
                            <FormControl variant="outlined" className={classes.selectBank} fullWidth={true}>
                                {selectValue === '' &&
                                    <InputLabel shrink={false}>Select a category (Optional)</InputLabel>
                                }
                                <Select
                                    // value={age}
                                    onChange={onSelect}
                ...
                <div className={classes.paymentMethodContent}>
                    <FormControl fullWidth>
                        <Typography className={classes.contentTitle}>Payment Method</Typography>
                        <RadioGroup row>
                            <Grid container spacing={2}>
                                <Grid item xs={6}>
                                    <FormControlLabel
                                        ...
                                        classes={paymentMethod === 'deposit' ? {root: classes.radioActive} : {root: classes.radio}}
                                    />
                                </Grid>
                                <Grid item xs={6}>
                                    <FormControlLabel
                                        ...
                                        labelPlacement="right"
                                        onChange={(e) => setPaymentMethodFunction(e.target.value)}
                                        classes={paymentMethod === 'bankTransfer' ? {root: classes.radioActive} : {root: classes.radio}}
                                    />
                                </Grid>
                            </Grid>
                        </RadioGroup>
                ...
                <div>
                    <Typography className={classes.contentTitle}>Payment Details</Typography>
            ...
            <Paper elevation={0} className={classes.footer}>
                <Grid container justify='space-between' style={{height: '100%'}}>
                    ...
                    <Grid item xs={6}>
                        <Button className={classes.nextButton} onClick={nextStep}>Next</Button>
                    </Grid>
                </Grid>
            </Paper>
        </div>
