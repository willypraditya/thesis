    ...
    return(
        <div className={classes.root}>
            <Container className={classes.container}>
                {file.length === 0 ? 
                    <div>
                        <Typography className={classes.uploadCsvHeader}>Upload CSV</Typography>
                        <Typography>If you don't have the CSV template, download it here.</Typography>
                        <input
                            accept="image/*"
                    ...
                    :
                    <div>
                        <Typography className={classes.uploadCsvHeader}>Uploaded file</Typography>
