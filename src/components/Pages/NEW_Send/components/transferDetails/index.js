    ...
    return (
        <div>
            <Paper elevation={0} className={classes.paper}>
                <Typography className={classes.transferDetailsTitle}>Transfer Details</Typography>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={6}>
                                    <FormControlLabel
                                        ...
                                        classes={radio === 'manualInput' ? {root: classes.radioActive} : {root: classes.radio}}
                                    />
                                </Grid>
                                <Grid item xs={6}>
                                    <FormControlLabel
                                        ...
                                        labelPlacement="right"
                                        onChange={(e) => onClickRadio(e)}
                                        classes={radio === 'csvUpload' ? {root: classes.radioActive} : {root: classes.radio}}
                                    />
                                </Grid>
                            </Grid>
                        </RadioGroup>
                ...
                <div className={classes.uploadCsv}>
                    <Typography className={classes.uploadCsvTitle}>Upload CSV</Typography>
                    <UploadCsv/>
                </div>
                }
                    ...
                    <Grid container alignItems="center" justify="space-between">
                        <Grid item xs={6}>
                            <Typography className={classes.recipientsListTitle}>
                                Recipients List {transactionsData.length > 0 && `(${transactionsData.length} recipients)`}
                            </Typography>
                        </Grid>
                        <Grid item xs={6}>
                            {radio === 'manualInput' && 
                                <Button className={classes.addRecipient} onClick={showAddRecipientModal}>
            ...
            <AddRecipient show={addRecipientModal} hideFunction={hideAddRecipientModal}/>
        </div>
    );
};
