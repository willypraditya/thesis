                ...
                <Container className={classes.checkboxContainer}>
                    <FormControlLabel
                        ...
                        label={
                            ...
                            through Neu's
                                <Typography display='inline' style={{fontWeight: 600}}> {neuBank} </Typography>
                            bank account.
                            </Typography>
                        }
                    />
    ...
    return (
        <div>
            <Paper elevation={0} className={classes.paper}>
                <Typography className={classes.bankSelectionAndAmountTitle}>Bank Selection & Amount</Typography>
