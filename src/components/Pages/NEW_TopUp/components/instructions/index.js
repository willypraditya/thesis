        ...
        <div>
          ...
          <Container className={classes.description}>
            ...
            <Typography style={{ marginTop: 20 }}>
              ...
              is added to your transaction amount as a payment identifier. By
              transferring the exact amount, the payment identification process
              will be faster. The unique code transferred will be added to your
              balance.
            </Typography>
          </Container>
        </div>
        <div>
          <List>
            <ListItem>
              ...
              <ListItemText>Login to your bank account.</ListItemText>
            </ListItem>
            <ListItem>
              <ListItemAvatar>
              ...
              <ListItemText>
                Add “PT Inklusi Keuangan Nusantara” as a recipient and complete
                your one time deposit using the information below.
              </ListItemText>
            </ListItem>
          </List>
        </div>
