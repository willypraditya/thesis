    ...
    return(
        <TableContainer className={classes.table}>
            <Table aria-label="simple table">
                <TableHead>
                    <TableRow>
                        <TableCell className={classes.tableHeader} align="left">Bank Destination</TableCell>
                        <TableCell className={classes.tableHeader} align="left">Account Number</TableCell>
                ...
                <TableBody>
                    {transactionsData.map((row) => (
                        <TableRow key={row.id}>
                            <TableCell className={classes.tableContent} align="left">{row.bankDestination}</TableCell>
                            <TableCell className={classes.tableContent} align="left">{row.accountNumber}</TableCell>
