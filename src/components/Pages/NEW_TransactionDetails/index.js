    ...
    return(
        <div>
            <Paper elevation={0} className={classes.transactionDetailsHeader}>
                <Typography className={classes.transactionsDetailsId}>ID {matchProps.match.params.id}</Typography>
                <Grid
                    container
                    direction='row'
                ...
                >
                    <Grid item>
                        <Grid
                            ...
                            spacing={3}
                        >
                            <Grid item className={classes.transactionDetailsHeaderDescriptions}>
                                <Typography className={classes.decriptionTitle}>Date</Typography>
                                <Typography>Jan 9, 2013 18:24</Typography>
                            </Grid>
                            <Grid item className={classes.transactionDetailsHeaderDescriptions}>
                                <Typography className={classes.decriptionTitle}>Categories</Typography>
                        ...
                        >
                            <Grid item className={classes.transactionDetailsHeaderDescriptions}>
                                <Typography className={classes.decriptionTitle}>Transaction Type</Typography>
                                <Typography>Single Fund Transfer</Typography>
                            </Grid>
                            <Grid item className={classes.transactionDetailsHeaderDescriptions}>
                                <Typography className={classes.decriptionTitle}>Payment Method</Typography>
                                <Typography>Wallet</Typography>
                            </Grid>
                        </Grid>
                    </Grid>
                    <Grid item>
                        <Typography className={classes.transactionDetailsHeaderAmountIncoming}>+ Rp 20.000.000,12</Typography>
            ...
            <Paper elevation={0} className={classes.transactionsDetailsContentPaper}>
                ...
                >
                    <Grid item>
                        <Typography className={classes.recipientText}>Recipient(s)</Typography>
                    </Grid>
                    <Grid item>
